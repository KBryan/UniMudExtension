...
```csharp
        // OP Node
        var _provider = new JsonRpcProvider("https://goerli.infura.io/v3/ADD_RPC_URL");
        var accountBalance = await _provider.GetBalance("0xE51995Cdb3b1c109E0e6E67ab5aB31CDdBB83E4a");
        var blockNumber = await _provider.GetBlockNumber();
        var getBlock = await _provider.GetBlock();
        var getTransaction = await _provider.GetTransaction("0xf6c38e1fc083f14059f4cdddcbe008805ec03c6f29490d2f727ea5636455d045");
        ...
        Debug.Log("Transaction Data: " + JsonConvert.SerializeObject(getTransaction, Formatting.Indented));
